...
class Notifier(configurable.Configurable):
    ...
    defaults = [
        ...
        (
            'foreground',
            (colors['light'], colors['light'], colors['light']),
        ...
        ('font', 'JetBrainsMono Nerd Font', 'Font used in notifications.'),
        ...
        ('horizontal_padding', 5, 'Padding at sides of text.'),
        ('vertical_padding', 3, 'Padding at top and bottom of text.'),
